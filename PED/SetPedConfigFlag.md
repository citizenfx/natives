...
enum ePedConfigFlags {
	...
	CPED_CONFIG_FLAG_ForceReload = 105, //Force a reload of the current weapon" hideFrom="script
	CPED_CONFIG_FLAG_DontActivateRagdollFromVehicleImpact = 106," description ="Blocks ragdoll activation when hit by a vehicle
	CPED_CONFIG_FLAG_DontActivateRagdollFromBulletImpact = 107," description ="Blocks ragdoll activation when hit by a bullet
	CPED_CONFIG_FLAG_DontActivateRagdollFromExplosions = 108," description ="Blocks ragdoll activation when hit by an explosive
	CPED_CONFIG_FLAG_DontActivateRagdollFromFire = 109," description ="Blocks ragdoll activation when set on fire
	CPED_CONFIG_FLAG_DontActivateRagdollFromElectrocution = 110," description ="Blocks ragdoll activation when electrocuted
	CPED_CONFIG_FLAG_IsBeingDraggedToSafety = 111," description ="Whether this ped is being dragged to safety
	CPED_CONFIG_FLAG_HasBeenDraggedToSafety = 112," description ="Whether this ped has been dragged to safety
	CPED_CONFIG_FLAG_KeepWeaponHolsteredUnlessFired = 113," description ="Ignores the creation of the weapon object unless the gun is shot.
	CPED_CONFIG_FLAG_ForceScriptControlledKnockout = 114," description ="Forces a melee knockout state for the victim ped
	CPED_CONFIG_FLAG_FallOutOfVehicleWhenKilled = 115," description ="Forces a ped to fall out of a vehicle when killed
	CPED_CONFIG_FLAG_GetOutBurningVehicle = 116," description ="If set, a ped will escape a burning vehicle they are inside 
	CPED_CONFIG_FLAG_BumpedByPlayer = 117," description ="Whether this ped has been bumped by the player.
	CPED_CONFIG_FLAG_RunFromFiresAndExplosions = 118," description ="If set, a ped will run away from fires or potential explosions 
	CPED_CONFIG_FLAG_TreatAsPlayerDuringTargeting = 119," description ="If set, the ped will be given the same boost a player gets in the targeting scoring system.
	...
	CPED_CONFIG_FLAG_BumpedByPlayerVehicle = 142," description ="Whether this ped has been bumped by a player vehicle.
	CPED_CONFIG_FLAG_DodgedPlayerVehicle = 143," description ="Whether this ped has just dodged a player vehicle.
	...
	CPED_CONFIG_FLAG_DodgedPlayer = 209," description ="Whether this ped has just dodged a player.
	...
	CPED_CONFIG_FLAG_ForcedToStayInCover = 211," description ="Ped won't move out of cover when set (not even to fire).
	...
	CPED_CONFIG_FLAG_AllowToBeTargetedInAVehicle = 214," description ="Ped can be targeting inside a vehicle
	CPED_CONFIG_FLAG_WaitForDirectEntryPointToBeFreeWhenExiting = 215," description ="
	CPED_CONFIG_FLAG_OnlyRequireOnePressToExitVehicle = 216," description ="
	CPED_CONFIG_FLAG_ForceExitToSkyDive = 217," description ="
	...
	CPED_CONFIG_FLAG_DisableExitToSkyDive = 221," description ="
	...
	CPED_CONFIG_FLAG_CanPlayInCarIdles = 248,"  description="If false, blocks in-car idle animations from playing.
	...
	CPED_CONFIG_FLAG_SimulatingAiming = 254,"  description="Simulating the aim button for player until on input detection.
	...
	CPED_CONFIG_FLAG_UpdateEnclosedSearchRegion = 284,"  description="This ped will update their enclosed regions" />
	...
	CPED_CONFIG_FLAG_DontActivateRagdollForVehicleGrab = 336," description ="Blocks ragdoll activation when grabbing vehicle doors
	CPED_CONFIG_FLAG_ForcePackageCharacterCloth = 337," description ="Set the flag for forcing package on character cloth when cloth is created on the ped
	...
	CPED_CONFIG_FLAG_DontActivateRagdollFromSmokeGrenade = 367," description ="Blocks ragdoll activation when damaged by smoke grenade
	...
	CPED_CONFIG_FLAG_PreventReactingToSilencedCloneBullets = 372," description ="Prevents the ped from reacting to silenced bullets fired from network clone peds
	CPED_CONFIG_FLAG_DisableInjuredCryForHelpEvents = 373," description ="Blocks ped from creating the injured cry for help events (run over, tazed or melee would usually do this)
	CPED_CONFIG_FLAG_NeverLeaveTrain = 374," description ="Prevents peds riding trains from getting off them
	...
	CPED_CONFIG_FLAG_PermanentlyDisablePotentialToBeWalkedIntoResponse = 440, //Synced and permanent version of CPED_CONFIG_FLAG_DisablePotentialToBeWalkedIntoResponse = 441,
	...
	CPED_CONFIG_FLAG_RagdollFloatsIndefinitely = 469, //Prevents a dead ped from sinking
